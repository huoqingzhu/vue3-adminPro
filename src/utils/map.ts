...
import {WebGLRenderer,Scene,DirectionalLight,SpriteMaterial,Vector3,Camera,Object3D,Raycaster,Vector2,OrthographicCamera,PerspectiveCamera,AmbientLight,Group,Sprite,Matrix4} from 'three'
